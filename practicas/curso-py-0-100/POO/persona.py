...
- Si existe un fallo en una pequeña parte del código el programa completo no debe fallar
necesariamente. Además, es más fácil de corregir esos fallos.
...
class Persona():
    ...
    # Funcionalidades:
    def despertar(self):
        # self: parámetro que hace referencia a la instancia/objeto perteneciente a la clase
        self.despierta = True
        print("Buen día.")
        pass
...
persona1 = Persona()
persona1.apellidos = "Loire"
print(persona1.apellidos)
persona1.despertar()
print(persona1.despierta)

persona2 = Persona()
persona2.apellidos = "Heartilly"
